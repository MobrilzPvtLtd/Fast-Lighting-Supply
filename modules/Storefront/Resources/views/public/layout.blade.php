...
<body
    ...
    style="
        --color-primary: {{ $themeColor->toHexString() }};
        --color-primary-hover: {{ $themeColor->darken(8)->toString() }};
        --color-primary-transparent: {{ $themeColor->setAlpha(0.8)->toString() }};
        --color-primary-transparent-lite: {{ $themeColor->setAlpha(0.3)->toString() }};
        --color-primary-transparent-lite-2: {{ $themeColor->setAlpha(0.12)->toString() }};
    "
>
